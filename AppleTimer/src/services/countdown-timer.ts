// Notes: issues of this v1 countdown-timer are:
// -- 1. it will pause when app goes to background
// -- 2. sometime, it skips certain ticked event (e.g.: you see 5secs, 3secs, maybe also 2secs ticked-event
// get triggered, but it skips 4secs ticked event)
export {}
